# -*- coding: utf-8 -*-
"""
Logyze - Анализ затухающих колебаний с датчиком RF603HS
Версия 2.1 с улучшенной визуализацией и отображением результатов на графике
"""
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        """Инициализация интерфейса"""
        self.setWindowTitle('Logyze - Анализатор затухающих колебаний v2.1')
